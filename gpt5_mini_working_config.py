# РАБОЧАЯ КОНФИГУРАЦИЯ GPT-5-MINI
# ВАЖНО: Учитывает ВСЕ реальные ограничения модели
...
# Параметры для GPT-5-mini (ТОЛЬКО ПОДДЕРЖИВАЕМЫЕ!)
GPT5_MINI_PARAMS = {
    'model': 'gpt-5-mini',
...
response = client.chat.completions.create(
    ...
    top_p=0.9,                   # Ошибка!
    frequency_penalty=0.1,        # Ошибка!
    presence_penalty=0.1          # Ошибка!
)
