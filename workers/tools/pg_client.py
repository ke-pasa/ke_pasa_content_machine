...
class PGClient:
    ...
    def save_generated_article(self, article_id: str, payload: Dict[str, Any]) -> bool:
        ...
        insert_sql = '''
        INSERT INTO public.articles_ru (article_id, source_url, source_link, source_name, source_published_at, image_url, status, total_score, title_ru, description_ru, content_ru, slug, telegram_final, script, published_at, updated_at)
